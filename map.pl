...
start :-
    ...
    write('You were sent to save the country by defeating all of the Legendary Tokemons who were being controlled by Dead Eye.'),nl,
    ...
    write('Beware and we wish you the best of luck, Fighter!'),nl,
    nl,
    help.
